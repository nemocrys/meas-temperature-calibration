...
## 5. Hardware setup:
![Hardware Setup](https://github.com/nemocrys/meas-temperature-calibration/pictures/setup.png)
...
### 6.2 Script:
![Plot](https://github.com/nemocrys/meas-temperature-calibration/pictures/plot.png)
